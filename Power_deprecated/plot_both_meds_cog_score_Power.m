...
scatter(mmse, Power_1, 300, 'filled', 'MarkerFaceColor', [1, 0, 1]);  % Magenta color
hold on;

% Plot the second group in dark green
scatter(mmse, Power_2, 300, 'filled', 'MarkerFaceColor', [0, 0.5, 0]);  % Dark green color
